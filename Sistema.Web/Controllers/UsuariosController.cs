...
namespace Sistema.Web.Controllers
{
    ...
    public class UsuariosController : ControllerBase
    {
        ...
        public async Task<IActionResult>Login (LoginViewModel model)
        {
            ...
            if (!VerficarPasswordHash(model.password, usuario.password_hash, usuario.password_salt))
            {
                return NotFound();
            }
        ...
        private bool VerficarPasswordHash(string password, byte[] passwordHashAlmacenado, byte[] passwordSalt)
        {
